...
async def process_model_response(client, response, page, max_iterations=ITERATIONS)-> str:
    ...
    for iteration in range(max_iterations):
        ...
        for item in response.output:
            ...
            if hasattr(item, 'type') and item.type == "output_text":
                print(f"\nModel message: {item.output_text}\n")
...
async def main():    
    ...
    async with async_playwright() as playwright:
        ...
        await page.goto("https://p2p-erp-web.gentleflower-4e1ad251.swedencentral.azurecontainerapps.io/ContractHeaders/ContractLines/CON000001", wait_until="domcontentloaded")
